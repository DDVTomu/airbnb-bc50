...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 border-b w-full bg-white z-20">
      <div className="container mx-auto px-2 sm:px-10 py-5 flex flex-wrap justify-between items-center">
        ...
        >
          <div className="hidden md:block">
            <svg width="102" height="32" fill="#F43F5E">
              ...
              <form className="flex flex-wrap justify-center items-center">
                  <div className="flex flex-wrap justify-center items-center relative  transition-all duration-300 h-0 overflow-hidden" >
                      <div className="px-5 py-2 hover:bg-gray-300 rounded-full h-full flex flex-wrap justify-center items-center" >
                          <label for="checkInDate" className="block text-sm font-medium text-gray-900 dark:text-gray-300">Địa điểm</label>
                          <div className="w-48 bg-transparent outline-none select_location css-b62m3t-container" >
                          <span id="react-select-3-live-region" className="css-7pg0cj-a11yText"></span><span aria-live="polite" aria-atomic="false" aria-relevant="additions text" className="css-7pg0cj-a11yText"></span>
                          <div className=" css-1s2u09g-control" >
                              <div className=" css-1d8n9bt" >
                                  ...
                                  <div className=" css-ackcql" data-value="" >
                                      <input className="" autoCapitalize="none" autoComplete="off" autoCorrect="off" id="react-select-3-input" spellCheck="false" tabIndex="0" type="text" aria-autocomplete="list" aria-expanded="false" aria-haspopup="true" role="combobox" value="" style={{color: "inherit", background: "0px center", opacity: "1", width: "100%", gridArea: "1 / 2 / auto / auto", font: "inherit", minWidth: "2px", border: "0px", margin: "0px", outline: "0px", padding: "0px"}}>
                                  </div>
                              </div>
                      ...
                      <div className="hidden sm:block py-2 px-5 hover:bg-gray-300 rounded-full overflow-hidden h-full" ><label for="checkInDate" className="block text-sm font-medium text-gray-900 dark:text-gray-300">Nhận phòng</label><input name="checkIn" type="date" id="checkInDate" className="bg-transparent outline-none" placeholder="Thêm ngày"></div>
                      <div className="hidden sm:block py-2 px-5 hover:bg-gray-300 rounded-full overflow-hidden h-full" ><label for="checkOutDate" className="block text-sm font-medium text-gray-900 dark:text-gray-300">Trả phòng</label><input name="checkOut" type="date" id="checkOutDate" className="bg-transparent outline-none" placeholder="Thêm ngày"></div>
                      <div className="hidden sm:block py-2 pl-7 pr-5 hover:bg-gray-300 rounded-full overflow-hidden h-full" ><label for="guest" className="block text-sm font-medium text-gray-900 dark:text-gray-300">Khách</label><input name="guest" type="number" id="guest" className="bg-transparent outline-none" placeholder="Thêm khách"></div>
        ...
        >
          <div className="relative flex items-center justify-end">
            ...
            <div className="block z-10">
              <div className="relative inline">
                ...
                <div className="hidden">
                  ...
                  <div className="font-normal flex flex-col">
                    <a
                      aria-current="page"
                      className="hover:bg-gray-100 pl-5 py-2 transition-all duration-200 active"
                      href="/"
                    >
                      Cho thuê nhà
                    </a>
              ...
              {user ? (
                <div
                  className="absolute right-0 z-50 rounded-md shadow flex-col mt-4 w-56 bg-white"
